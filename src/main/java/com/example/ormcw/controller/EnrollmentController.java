...
import com.example.ormcw.tm.CartTm;
...
public class EnrollmentController {
    ...
    void btnViewRegisOnAction(ActionEvent event) {
        ...
        try {
            inNode = FXMLLoader.load(this.getClass().getResource("/com/example/ormcw/view_enrollment.fxml"));
        } catch (IOException e) {
    ...
    void btnPaymentOnAction(ActionEvent event) {
        AnchorPane inNode = null;
        try {
            inNode = FXMLLoader.load(this.getClass().getResource("/com/example/ormcw/paymentform.fxml"));
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
        rootNode.getChildren().clear();
    ...
    void txtPaymentOnKeyReleased(KeyEvent event) {
        Regex.setTextColor(com.example.ormcw.util.TextField.PRICE,txtUpfrontPayment);
    }

    public int isValied(){
        if (!Regex.setTextColor(com.example.ormcw.util.TextField.PRICE,txtUpfrontPayment)) return 1;
        return 0;
    }
}
