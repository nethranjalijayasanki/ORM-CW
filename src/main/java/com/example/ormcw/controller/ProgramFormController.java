...
import com.example.ormcw.tm.ProgramTm;
...
public class ProgramFormController {
    ...
    void txtDurationOnKeyReleased(KeyEvent event) {
        Regex.setTextColor(com.example.ormcw.util.TextField.ADDRESS,txtDuration);
    }

    @FXML
    void txtFeeOnKeyReleased(KeyEvent event) {
        Regex.setTextColor(com.example.ormcw.util.TextField.PRICE,txtFee);
    }

    @FXML
    void txtNameOnKeyReleased(KeyEvent event) {
        Regex.setTextColor(com.example.ormcw.util.TextField.NAME,txtProgramName);
    }

    public int isValied(){
        if (!Regex.setTextColor(com.example.ormcw.util.TextField.NAME,txtProgramName)) return 1;
        if (!Regex.setTextColor(com.example.ormcw.util.TextField.ADDRESS,txtDuration)) return 2;
        if (!Regex.setTextColor(com.example.ormcw.util.TextField.PRICE,txtFee)) return 3;
