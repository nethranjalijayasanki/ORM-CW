...
import com.example.ormcw.tm.StudentTm;
...
public class StudentFormController {
    ...
    void txtAddressOnKeyReleased(KeyEvent event) {
        Regex.setTextColor(com.example.ormcw.util.TextField.ADDRESS ,txtAddress);
    }

    @FXML
    void txtContactOnKeyReleased(KeyEvent event) {
        Regex.setTextColor(com.example.ormcw.util.TextField.PHONENO,txtContact);
    }

    @FXML
    void txtEmailOnKeyReleased(KeyEvent event) {
        Regex.setTextColor(com.example.ormcw.util.TextField.EMAIL,txtEmail);
    }

    @FXML
    void txtNameOnKeyReleased(KeyEvent event) {
        Regex.setTextColor(com.example.ormcw.util.TextField.NAME,txtStudentName);
    }

    public int isValied(){
        if (!Regex.setTextColor(com.example.ormcw.util.TextField.NAME,txtStudentName)) return 1;
        if (!Regex.setTextColor(com.example.ormcw.util.TextField.PHONENO,txtContact)) return 2;
        if (!Regex.setTextColor(com.example.ormcw.util.TextField.EMAIL,txtEmail)) return 3;
        if (!Regex.setTextColor(com.example.ormcw.util.TextField.ADDRESS,txtAddress)) return 4;
        return 0;
    }
