...
public class AdminSignupController {
    ...
    private UserformController usersFormController; // Reference to UsersFormController
    ...
    public void setUsersFormController(UserformController usersFormController) {
