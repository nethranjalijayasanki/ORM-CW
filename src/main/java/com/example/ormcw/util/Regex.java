package com.example.ormcw.util;
...
public class Regex {
    public static boolean isTextFieldValid(com.example.ormcw.util.TextField textField, String text){
        String filed = "";
    ...
    public static boolean setTextColor(com.example.ormcw.util.TextField location, TextField textField){
